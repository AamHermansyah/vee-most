        ...
        <footer className="bg-white">
            ...
            <div className="w-full h-auto px-4 py-6 lg:pt-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <div className="flex items-center">
                            <img src={Logo.src} className="h-[100px] w-auto ml-8 mr-3" alt="FlowBite Logo" />
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">© 2023 <a href="https://flowbite.com/" className="hover:underline">Veemost™</a>. All Rights Reserved.
                    </span>
