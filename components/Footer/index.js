...
import LogoWhite from '../../assets/Veemost-White.png'
    ...
    <footer className="mt-10 sm:mt-0 bg-gray-900 -mb-10">
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
            ...
            <div>
                ...
                >
                Veemoststore is a dynamic and innovative company that specializes in providing exceptional lifestyle solutions to its diverse clientele. 
                </p>
                ...
                <li>
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="transition text-teal-500 hover:text-teal-500/75"
                    >
            ...
            >
                ...
                <ul className="mt-8 space-y-4 text-sm">
                    ...
                    <address
                        className="-mt-0.5 flex-1 not-italic  text-gray-300"
                    >
            ...
            <div className="text-center sm:flex sm:justify-between sm:text-left">
                ...
                <a
                    className="inline-block  underline transition  text-teal-500 hover:text-teal-500/75"
                    href="/"
                >
                    Terms & Conditions
                </a>
                ...
                <p
                className="mt-4 text-sm text-gray-400 sm:order-first sm:mt-0"
                >
                &copy; 2022 Veemost Store
                </p>
            </div>
            </div>
        </div>
